...
- **2026-01-04**: MVP Local Hardening (Version 2.1)
  - Automatischer Decoder-Download (Draco/KTX2 von CDN)
  - Automatisches ENV-Setup (.env.local aus .env.example)
  - Verbesserte Platzhalter-Szene (Sky, Grid, Geometrie - kein schwarzer Screen)
