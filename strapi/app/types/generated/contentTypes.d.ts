...
export interface ApiAssetAsset extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    draco: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    idStr: Schema.Attribute.String & Schema.Attribute.Required;
    ktx2: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiAudioBeaconAudioBeacon extends Struct.CollectionTypeSchema {
  collectionName: 'audio_beacons';
  info: {
    displayName: 'Audio Beacon';
    pluralName: 'audio-beacons';
    singularName: 'audio-beacon';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    idStr: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::audio-beacon.audio-beacon'> &
      Schema.Attribute.Private;
    pos: Schema.Attribute.JSON & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    radius: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<8>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
...
export interface ApiPortalPortal extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::portal.portal'> &
      Schema.Attribute.Private;
    position: Schema.Attribute.JSON & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiSceneScene extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    audioBeacons: Schema.Attribute.Relation<'oneToMany', 'api::audio-beacon.audio-beacon'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    portals: Schema.Attribute.Relation<'oneToMany', 'api::portal.portal'>;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'name'>;
    spawn: Schema.Attribute.JSON;
    ui: Schema.Attribute.JSON;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
...
export interface ApiZoneZone extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    idStr: Schema.Attribute.String & Schema.Attribute.Required;
    isStage: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    shape: Schema.Attribute.Enumeration<['circle', 'polygon']> & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::audio-beacon.audio-beacon': ApiAudioBeaconAudioBeacon;
